...
from scrts import BOT_TOKEN, HYPIXEL_API_KEY, RAGINGENBY_API_KEY, MONGODB_URI
...
ITEM_ID_ROLES: dict[str, int] = {
    ...
    "PET_SKIN_ELEPHANT_RED,PET_SKIN_ELEPHANT_PURPLE,PET_SKIN_ELEPHANT_GREEN": 1296964784981282816, # @Elephant Heirs
    ...
    "PET_SKIN_ENDERMAN,PET_SKIN_ENDERMAN_SLAYER,PET_SKIN_ENDERMAN_NEBULA,PET_SKIN_ENDERMAN_SUN,PET_SKIN_ENDERMAN_BLUE_MOON,PET_SKIN_ENDERMAN_NEON,PET_SKIN_ENDERMAN_XENON": 1310693495970988135, # @Enderman Skins
    "PET_SKIN_BEE_HIVE,PET_SKIN_BEE_HONEY,PET_SKIN_BEE_USB,PET_SKIN_BEE_RUGBEE,PET_SKIN_BEE_ZOMBEE,PET_SKIN_BEE_WANNA_BEE,PET_SKIN_BEE_GREAT_GATSBEE,PET_SKIN_BEE_BEELOVED,PET_SKIN_BEE_WASABEE,PET_SKIN_BEE_BEEDAZZLED,PET_SKIN_BEE_RGBEE,PET_SKIN_BEE_SPELLING_BEE": 1310693793586217081, # @Bee Skins
    "PET_SKIN_RAT_NINJA,PET_SKIN_RAT_SQUEAKHEART,PET_SKIN_RAT_SECRAT_SERVICE,PET_SKIN_RAT_JUNK_RAT,PET_SKIN_RAT_RAT-STRONAUT,PET_SKIN_RAT_LUNAR,PET_SKIN_RAT_KARATE,PET_SKIN_RAT_PIRATE,PET_SKIN_RAT_MR_CLAWS,PET_SKIN_RAT_GYM_RAT,PET_SKIN_RAT_SECURATY_GUARD,PET_SKIN_RAT_HIDE_AND_SQUEAK": 1310694980968382525, # @Rat Skins
}
